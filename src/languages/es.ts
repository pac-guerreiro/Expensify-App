...
export default {
    ...
    walletPage: {
        ...
        addPaymentMethod: 'Agregue un método de pago para enviar y recibir pagos directamente en la aplicación.',
        getPaidBackFaster: 'Recibe tu dinero más rápido',
        secureAccessToYourMoney: 'Acceso seguro a su dinero',
        receiveMoney: 'Recibe dinero en tu moneda local',
        expensifyWallet: 'Expensify Wallet',
        sendAndReceiveMoney: 'Envía y recibe dinero desde tu Expensify Wallet.',
        bankAccounts: 'Cuentas bancarias',
        addBankAccountToSendAndReceive: 'Agregue una cuenta bancaria para enviar y recibir pagos directamente en la aplicación.',
